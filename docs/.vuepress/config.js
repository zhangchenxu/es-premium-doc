...
module.exports = {
  ...
  title: "ES Premium",
  description: '一款更简洁、更优雅、更纯粹的ES查询框架',
    ...
    nav: [
      { text: '首页', link: '/' },
      {
        text: '指南', link: '/pages/52d5c3/', items: [
          { text: '快速开始', link: '/pages/52d5c3/' },
          { text: 'API文档', link: '/pages/a2f161/' }
        ]
      },
      // {
      ...
      icons: [
        {
          ...
          title: '发邮件',
          link: 'chenxu.zhang@chimeinc.com'
        },
        {
          iconClass: 'icon-github',
          title: 'GitHub',
          link: 'https://gitlab.d.chime.me/lofty-new/lofty-common/-/tree/master/lofty-es-starter'
        }
      ]
    },
    footer: { // 页脚信息
      createYear: 2022, // 博客创建年份
      copyrightInfo: 'Ethan Zhang', // 博客版权信息，支持a标签
    },
    htmlModules,
  },
